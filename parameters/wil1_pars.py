...
## Obj
obj_radius = 1.808 #half-light radius, arcmin
cluster_distance = 38.0e3 #pc
pos = (162.3436, 51.0501)

## Cluster stars distribution
cl_rad = 1.8 #arcminutes
error_function = None
...
bkg_ra = ((-0.45, 0.3),(-0.45,0.45))
bkg_dec = ((-0.4,-0.1),(0.1,0.42))
delta_mag_bkg=0.1
